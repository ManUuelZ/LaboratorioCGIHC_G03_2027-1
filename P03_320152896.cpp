...
void CrearPiramideRegular()
{
	GLfloat vertices_piramide[] = {
		...
		-0.5f, -0.5f,  0.5f,   0.6f, 0.0f, 0.7f,
		 0.0f,  0.5f,  0.0f,   0.6f, 0.0f, 0.7f
	};

	MeshColor* piramide_color = new MeshColor();
	piramide_color->CreateMeshColor(vertices_piramide, 18);
	meshColorList.push_back(piramide_color);
}
...
int main()
{
	...
	CrearCilindro(50, 1.0f);//índice 2 en MeshList cilindro resolución 5
	CrearCono(25, 2.0f);//índice 3 en MeshList cono resolución 20
	CrearPiramideCuadrangular();//índice 4 en MeshList
	CrearPiramideRegular();//índice 0 en MeshList
	CreateShaders();
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//1. Crear un cohete espacial con instancias de: pirámides, cilindros, esferas, conos, y cubos.
	
		// Cuerpo principal del cohete (cilindro)
		model = glm::mat4(1.0f);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 2.9f, -4.0f));
		...
		// "Ala" izquierda (pirámide cuadrangular)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-0.6f, 0.9f, -4.0f));
		...
		// "Ala" derecha (pirámide cuadrangular)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.6f, 0.9f, -4.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.8f, 0.4f));
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		// "Ala" trasera (pirámide cuadrangular)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.9f, -4.6f));
		model = glm::scale(model, glm::vec3(0.4f, 0.8f, 0.4f));
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[4]->RenderMesh();

		// "Ala" delantera (pirámide cuadrangular)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.9f, -3.4f));
		model = glm::scale(model, glm::vec3(0.4f, 0.8f, 0.4f));
		model = glm::rotate(model, glm::radians(-30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[4]->RenderMesh();

		// Cristal de la ventana (esfera)
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 1.8f, -3.5f));
		...
		// Flama del motor (pirámide triangular)
		model = glm::mat4(1.0f);
		...
		model = glm::scale(model, glm::vec3(6.0f, 0.1f, 5.0f));
		...
		/*
		//2. Generar la figura de unión de 8 pirámides.
		...
		//Pirámide 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.1f, 0.7f, -2.0f));
		...
		//Pirámide 5
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.25f, 0.4f, -2.0f));
		...
		//Pirámide 6
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.55f, 0.4f, -2.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//Pirámide 7
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.35f, 0.4f, -2.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//Pirámide 8
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.05f, 0.4f, -2.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
